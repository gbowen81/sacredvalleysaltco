...
<nav class="headermenu regmenu flex-container">
  <ul class="inline-flex menuleft">
    <li class="menuitem menuleft menulogo">
      <a class="toplevel pagehighlight" href="/">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 100" version="1.1" enable-background="new">
            <defs>
                <filter id="a" color-interpolation-filters="sRGB">
                    <feBlend mode="luminosity" in2="BackgroundImage"/>
                </filter>
            </defs>
            <g opacity="1" filter="url(#a)" stroke="none">
                <flowRoot xml:space="preserve" style="line-height:1.25" transform="scale(.26458)" font-style="normal" font-weight="400" font-size="40" font-family="sans-serif" letter-spacing="0" word-spacing="0" fill-opacity="1">
                    <flowRegion>
                        <path d="M151.429 61.524h414.286v62.143H151.429z"/>
                    </flowRegion>
                    <flowPara/>
                </flowRoot>
                <flowRoot xml:space="preserve" style="line-height:1.25" transform="scale(.26458)" font-style="normal" font-weight="400" font-size="40" font-family="sans-serif" letter-spacing="0" word-spacing="0" fill-opacity="1">
                    <flowRegion>
                        <path d="M92.857 31.47h554.651v67.911H92.857z"/>
                    </flowRegion>
                    <flowPara/>
                </flowRoot>
                <flowRoot xml:space="preserve" style="line-height:1.25" transform="scale(.26458)" font-style="normal" font-weight="400" font-size="40" font-family="sans-serif" letter-spacing="0" word-spacing="0" fill-opacity="1">
                    <flowRegion>
                        <path d="M260.619 330.476h258.599v43.437H260.619z"/>
                    </flowRegion>
                    <flowPara>
                        s
                    </flowPara>
                </flowRoot>
                <g stroke-width=".265" stroke-linecap="butt" stroke-linejoin="miter" stroke-opacity="1">
                    <path d="M155.13 28.888l-.908 7.911c-3.118 1.85-7.846 2.104-7.846 2.104H92.934l.92-6.97h51.426s4.077-.043 9.85-3.045zM105.363 66.355H89.227l3.44-25.209h23.356s-1.696 14.42-10.66 25.209zM153.672 38.85l-.872 7.744c-5.815 1.602-7.704 1.442-7.704 1.442h-28.443c.969-3.845 1.502-6.89 1.502-6.89h25.971s4.41-.106 9.546-2.296zM141.065 57.192H113.04c2.398-4.683 2.878-6.949 2.878-6.949h27.547zM129.69 59.231h-17.782c-1.919 3.928-4.42 7.062-4.42 7.062h19.461zM3.705 28.888l.908 7.911c3.117 1.85 7.846 2.104 7.846 2.104H65.9l-.921-6.97H13.555s-4.077-.043-9.85-3.045zM53.472 66.355h16.135l-3.44-25.209H42.812s1.696 14.42 10.66 25.209zM5.163 38.85l.872 7.744c5.814 1.602 7.704 1.442 7.704 1.442h28.443c-.969-3.845-1.502-6.89-1.502-6.89H14.708s-4.41-.106-9.545-2.296zM17.77 57.192h28.026c-2.398-4.683-2.878-6.949-2.878-6.949H15.371zM29.145 59.231h17.782c1.919 3.928 4.42 7.062 4.42 7.062H31.886zM71.855 68.408h15.041l2.638 13.898H69.182zM91.899 31.928H67.024l4.591 34.365h15.692zM82.065 29.926h9.816v-5.041zM73.277 26.98s-2.227.397-2.022 2.87c0 0 .446-.962 3.084-.83 0 0 1.045 1.85 4.026.396 0 0 .856-.585 3.769-1.208 0 0 2.792-1.228 1.285-4.494 0 0-1.217-2.757-4.403-1.209 0 0-1.302-2.247-4.42.567 0 0-2.861 2.058-1.32 3.908z"/>
97.08h-2.643q-.085-.868-.41-1.729-.11-.294-.737-1.674h-3.922q-.489 1.287-.605 1.667-.302.953-.325 1.736h-2.69q.806-.93 2.093-3.62l3.573-7.457 3.667 7.705q.922 1.961 2 3.372zm-4.402-4.767l-1.35-3.248-1.379 3.248zM77.149 94.933l-.907 2.147h-5.566q.373-1.248.373-3.279v-4.666q0-1.806-.373-2.97h2.427q-.38 1.357-.38 2.93v6.799q2.333-.163 4.426-.961zM86.455 86.166l-.535 1.76q-.83-.373-1.426-.481-.473-.085-1.496-.093v6.085q0 2.38.372 3.643h-2.426q.38-1.14.38-3.705v-6.023q-1.186.077-1.76.155-.954.14-1.705.418l.589-1.76zM100.842 94.607l-.085 1.814q-1.883.822-3.403.822-2.403 0-3.914-1.512-1.512-1.52-1.512-3.914 0-2.574 1.636-4.194 1.643-1.62 4.209-1.62 1.31 0 2.798.442v1.868q-1.597-.992-3-.992-1.813 0-2.868 1.279-.984 1.186-.984 3.046 0 1.822.922 2.992 1.008 1.287 2.775 1.287 1.605 0 3.426-1.318zM113.086 91.638q0 2.388-1.581 4-1.581 1.605-3.969 1.605-2.48 0-4.054-1.597-1.573-1.605-1.573-4.093 0-2.418 1.674-4 1.651-1.55 4.085-1.55 2.395 0 3.922 1.628 1.496 1.597 1.496 4.007zm-1.798.318q0-1.79-1.03-3.147-1.133-1.488-2.869-1.488-1.651 0-2.69 1.14-1 1.1-1 2.767 0 1.86 1.039 3.216 1.132 1.48 2.946 1.48 1.62 0 2.643-1.193.961-1.132.961-2.775zM116.82 96.033l-.032.256-.969 1.047h-.194l-1.17-.97v-.193l1.03-1.093h.187z" style="-inkscape-font-specification:'Narkisim, Normal';font-variant-ligatures:normal;font-variant-caps:normal;font-variant-numeric:normal;font-feature-settings:normal;text-align:start"/>
                </g>
            </g>
        </svg>
      </a>
    </li>
    <li class="menuitem menuleft"><a class="toplevel pagehighlight" href="the-salt.php"><span>The Salt</span></a></li>
    <li class="menuitem menuleft"><a class="toplevel pagehighlight" href="the-journey.php"><span>Origin</span></a></li>
    <li class="menuitem menuleft"><a class="toplevel pagehighlight" href="our-principles.php"><span>Ethics</span></a></li>
    <li id="testid" class="menuitem menuleft"><a class="toplevel pagehighlight" href="the-people.php"><span>People</span></a></li>
    <li class="menuitem menuleft"><a class="toplevel pagehighlight" href="no-hype-zone.php"><span>No Hype</span></a></li>
    <li class="menuitem menuleft dropdown">
      <a href="javascript:void(0)" class="dropbtn">
      <span>Learn</span>
      <img src="assets/images/down-arrow-white.png" class="downarrow">
      </a>
      <div class="dropdown-content">
        <a class="pagehighlight1" href="blog.php">Blog</a>
        <a class="pagehighlight2" href="photo-blog.php">Photo Blog</a>
        <a class="pagehighlight3" href="andean-condor.php">Andean Condor</a>
      </div>
    </li>
  </ul>


  <ul class="inline-flex menuright">   
    <li class="menuitem menuright">
      <a class="toplevel pagehighlight" href="get-salt.php">
        <span>Get Salt</span>
        <img src="/assets/images/salt-pouch-120sq.png" class="menupic">
      </a>
    </li>
  </ul>
</nav>
...
<ul class="flex-container">
  <li class="menuitem">
    <a class="pagehighlight toplevel" href="/">
      <div class="menuicon">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 100" version="1.1" enable-background="new">
          <defs>
              <filter id="a" color-interpolation-filters="sRGB">
  ...
  <li class="menuitem">
    <a class="toplevel pagehighlight" href="the-salt.php">
    <div class="menuicon">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 81" version="1.1">
  ...
  <li class="menuitem">
    <a class="toplevel pagehighlight" href="our-principles.php">
    <div class="menuicon">
      <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 100 100">
        <g fill="#fff" fill-opacity="1" stroke="none">
  ...
  <li class="menuitem">
    <a class="toplevel pagehighlight" href="the-people.php">
    <div class="menuicon">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" version="1.1">
          <g transform="matrix(1.0993 0 0 1.0993 -5.47 -5.585)">
  ...
  <li class="menuitem">
    <a class="toplevel pagehighlight" href="no-hype-zone.php">
    <div class="menuicon">
      <img src="/assets/images/no-hype-60.png">
    </div>
    <div class="icontext">
      <p>No Hype</p>
    </div>
...
<nav class="headermenu fullmenu flex-container">
  <div class="menuitem menulogo">
    <a href="/" class="toplevel">
      <img src="/assets/images/condor-nav.png">
    </a>
  </div>
...
<div id="myNav" class="overlay flex-container">
  ...
  <ul class="overlay-content">
    <li class="menuitem">     
      <a href="/" class="pagehighlight">
        <div class="fullimg"><img src="/assets/images/condor-nav.png"></div>
        <span>Home</span>
      </a>
    </li>
    <li class="menuitem">
      <a href="the-salt.php" class="pagehighlight">
        <div class="fullimg"><img src="/assets/images/salt-icon-white-60.png"></div>
        <span>The Salt</span>
      </a>
    </li>
    <li class="menuitem"> 
      <a href="the-journey.php" class="pagehighlight">
        <div class="fullimg"><img src="/assets/images/andes-icon-white-60.png"></div>
        <span>Origin</span>
      </a>
    </li>
    <li class="menuitem">
      <a href="our-principles.php" class="pagehighlight">
        <div class="fullimg"><img src="/assets/images/compass-white-60.png"></div>
        <span>Ethics</span>
      </a>
    </li>
    <li class="menuitem">
      <a href="the-people.php" class="pagehighlight">
        <div class="fullimg"><img src="/assets/images/the-people-60.png"></div>
        <span>People</span>
      </a>
    </li>
    <li class="menuitem">
      <a href="no-hype-zone.php" class="pagehighlight">
      <div class="fullimg"><img src="/assets/images/no-hype-60.png"></div>
      <span>No Hype</span>
      </a>
    </li>
    <div class="sv">
      <div class="list">
        <li><a href="blog.php" class="pagehighlight">Blog</a></li>
        <li><a href="photo-blog.php" class="pagehighlight">Photo Blog</a></li>
        <li><a href="andean-condor.php" class="pagehighlight">Andean Condor</a></li>
      </div>
      <div class="learn">
        <p>LEARN</p>
      </div>
    ...
    <li class="menuitem">
      <a href="get-salt.php" class="pagehighlight">
